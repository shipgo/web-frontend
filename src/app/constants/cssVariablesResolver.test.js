 ...
 * patrón, para `<Badge color="indigo">`, "En vehículo") a la lista. No
 * reemplaza la verificación de contraste real con axe-core (ver
 * `e2e/cases/axe-dark-mode-badges.js`) — sólo previene que alguien borre por
 * accidente la rama `dark` o deje el mismo valor en las dos.
 */
describe("cssVariablesResolver — tokens de contraste de badges/botones de estado", () => {
  ...
  it("define los 5 tokens en la rama light y en la rama dark", () => {
